...
var $author$project$Rests$subscriptions = function (model) {
	return A2($elm$time$Time$every, 1000, $author$project$Rests$Tick);
};
var $author$project$Rests$Resting = function (a) {
	return {$: 'Resting', a: a};
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SetsChosen':
				...
				var sets = msg.b;
				return _Utils_Tuple2(
					A2($author$project$Rests$SelectingRests, button, sets),
...
var $author$project$Rests$main = $elm$browser$Browser$element(
	{init: $author$project$Rests$init, subscriptions: $author$project$Rests$subscriptions, update: $author$project$Rests$update, view: $author$project$Rests$view});
